...
Weather.hPaTommHg = function (value) {
  console.log(value);
  return value * 0.750064;
};
...
//скорость ветра, м/с
Weather.Current.prototype.windspeed = function () {
  return this.data.list[0].wind.speed;
};
...
//иконку
Weather.Current.prototype.iconImg = function () {
